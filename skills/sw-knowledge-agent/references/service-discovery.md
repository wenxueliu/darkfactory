...
将检测结果写入 `_context/memory/sw-shared/service-registry.yaml`:

```yaml
# Auto-generated by sw-knowledge-agent service-discovery
# DO NOT EDIT MANUALLY — regenerated on each discovery run
generated_at: "{timestamp}"
generated_by: "sw-knowledge-agent"
